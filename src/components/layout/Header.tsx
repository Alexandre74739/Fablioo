...
export default function Header() {
  ...
  return (
    <header className="fixed inset-x-0 top-0 z-50 flex justify-center px-4">
      <div
        className={`mx-auto flex h-20 w-full max-w-7xl items-center justify-between px-5 transition-all duration-500 ease-out ${
          scrolled
      ...
      <div className="absolute inset-x-0 top-full flex justify-center px-4 md:hidden">
        <div
          className={`grid w-full max-w-7xl overflow-hidden bg-paper shadow-[0_8px_20px_-4px_rgba(36,29,26,0.25)] transition-all duration-300 ease-in-out ${
            scrolled ? "mt-2 rounded-3xl" : "mt-0 rounded-b-3xl"
